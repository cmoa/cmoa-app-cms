...
.promise().done( function(){
  ...
  $('.file-input-wrapper input[type=file]').change(function(){
    ...
    if ($(this).prop('files').length > 1) {
      $(this).parent().after('<span class="file-input-name label">'+$(this)[0].files.length+' files</span>');
    }
    else {
      $(this).parent().after('<span class="file-input-name label">'+$(this).val().replace('C:\\fakepath\\','')+'</span>');
    }
